...
/**
 * The class is responsible for getting import
 */
class GetImport
{
    /**
     * Endpoint pattern '/imports/v1/{projectToken}/{importId}'
     */
     ...
     */
    public function execute(string $importId): array
    {
        ...
        try {
            ...
            throw new LocalizedException(
                __(
                    'Unable to get the import. Original error message: %error_message.',
