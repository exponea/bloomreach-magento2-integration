...
/**
 * Controller for displaying a list of imports
 */
class Index extends Action implements HttpGetActionInterface
{
     ...
     * @see _isAllowed()
     */
    public const ADMIN_RESOURCE = 'Bloomreach_EngagementConnector::initial_import_view';
    ...
    public function execute()
    {
        try {
            ...
            $errors[] = __('Failed to open the Initial Import page.');
            $errors[] = $e->getMessage();
        ...
        $resultPage->setActiveMenu('Bloomreach_EngagementConnector::initial_import_view');
        $resultPage->getConfig()->getTitle()->prepend(__('Initial Import'));
