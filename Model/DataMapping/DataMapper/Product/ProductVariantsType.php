...
/**
 * Maps product data to Bloomreach data for product variants type
 */
class ProductVariantsType implements DataMapperInterface
{
    public const ENTITY_TYPE = 'catalog_product_variants';
