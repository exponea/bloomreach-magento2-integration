...
/**
 * The class is responsible for rendering the final price in selected currency
 */
class PriceLocalCurrency implements RenderInterface
{
    /**
    ...
    {
        return $this->priceDataResolver->getFinalPrice($entity);
    }
}
