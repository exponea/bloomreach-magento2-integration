...
/**
 * The class is responsible for rendering the value of order item for product field
 */
class ProductField implements RenderInterface
{
    /**
    ...
    /**
     * Render the value of order item field for product object
     *
    ...
    public function render($entity, string $fieldCode)
    {
        ...
        return $product ? (string) $this->getAttributeValue->execute(
            $product->getData($fieldCode),
            $fieldCode,
